...
public class SalonsFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener
{
    ...
    {
        View v = inflater.inflate(R.layout.fragment_salons, container, false);
