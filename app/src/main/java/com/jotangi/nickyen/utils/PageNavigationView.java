...
import com.jotangi.nickyen.utils.internal.CustomItemLayout;
import com.jotangi.nickyen.utils.internal.CustomItemVerticalLayout;
import com.jotangi.nickyen.utils.internal.MaterialItemLayout;
import com.jotangi.nickyen.utils.internal.MaterialItemVerticalLayout;
import com.jotangi.nickyen.utils.internal.Utils;
import com.jotangi.nickyen.utils.item.BaseTabItem;
import com.jotangi.nickyen.utils.item.MaterialItemView;
import com.jotangi.nickyen.utils.item.OnlyIconMaterialItemView;
import com.jotangi.nickyen.utils.listener.OnTabItemSelectedListener;
...
//            if (mViewPager != null) { //要改第三個fragment點選不切換導航欄icon顏色 有修改到
            if (mViewPager != null && index != 2) {
    ...
    public class CustomBuilder {
        ...
        public NavigationController build() {
            ...
            if (enableVerticalLayout) {//垂直布局
                ...
                verticalItemLayout.setClipChildren(false);
                ...
                customItemLayout.setClipChildren(false);
...
//            if(position == 2) {
//                Context ctx = PageNavigationView.this.getContext();
//                if(ctx instanceof Activity) {
//                    ctx.startActivity(new Intent(ctx, SurfaceViewActivity.class));
//                    Log.d("測試", "setSelect: ");
//                }
//            }
        }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            if (mNavigationController != null && selected != 0) {
