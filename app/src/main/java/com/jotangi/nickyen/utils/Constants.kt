...
/**
 *Created by Luke Liu on 2021/9/14.
 */
...
object Constants {
    ...
    object Questionnaire {
        //        val coupons = arrayOf("QUESTIONNAIRE_COUPON7", "QUESTIONNAIRE_COUPON8", "QUESTIONNAIRE_COUPON9", "QUESTIONNAIRE_COUPON10")
        val coupons = arrayOf(
            "QUESTIONNAIRE_COUPON1",
            "QUESTIONNAIRE_COUPON2",
            "QUESTIONNAIRE_COUPON3",
            "QUESTIONNAIRE_COUPON4",
            "QUESTIONNAIRE_COUPON5",
            "QUESTIONNAIRE_COUPON6",
            "QUESTIONNAIRE_COUPON8",
            "QUESTIONNAIRE_COUPON9",
            "QUESTIONNAIRE_COUPON10"
        )
    }
    ...
    object Receipt {
        val receipt = arrayOf("個人電子發票", "手機載具", "統一編號電子發票")
    }

    object City {
        val counties = arrayOf(
            "臺北市", "新北市", "桃園市", "新竹縣", "新竹市",
            "苗栗縣", "臺中市", "彰化縣", "雲林縣", "嘉義縣", "嘉義市", "臺南市",
            "高雄市", "屏東縣", "南投縣", "基隆市", "宜蘭縣", "花蓮縣", "臺東縣",
            "澎湖縣", "連江縣", "金門縣"
        )

        // 台北市
        val districts00 = arrayOf(
            "中正區", "大同區", "中山區", "松山區", "大安區", "萬華區", "信義區",
            "士林區", "北投區", "內湖區", "南港區", "文山區"
        )

        // 基隆市
        val districts01 = arrayOf(
            "仁愛區", "信義區", "中正區", "中山區", "安樂區", "暖暖區", "七堵區"

        )

        // 新北市
        val districts02 = arrayOf(
        ...
        // 新竹市
        val districts05 = arrayOf(
            "東區", "北區", "香山區"
        )

        // 新竹縣
        val districts06 = arrayOf(
            "竹北市", "湖口鄉", "新豐鄉", "新埔鎮", "關西鎮", "芎林鄉", "寶山鄉",
            "竹東鎮", "五峰鄉", "橫山鄉", "尖石鄉", "北埔鄉", "峨眉鄉"
        )

        // 苗栗縣
        val districts07 = arrayOf(
        ...
        // 南投縣
        val districts10 = arrayOf(
            "南投市", "中寮鄉", "草屯鎮", "國姓鄉", "埔里鎮", "仁愛鄉", "名間鄉", "集集鎮",
            "水里鄉", "魚池鄉", "信義鄉", "竹山鎮", "鹿谷鄉"
        )

        // 嘉義市
        val districts11 = arrayOf(
            "東區", "西區"
        )

        // 嘉義縣
        val districts12 = arrayOf(
        ...
        // 澎湖縣
        val districts16 = arrayOf(
            "馬公市", "西嶼鄉", "望安鄉", "七美鄉", "白沙鄉", "湖西鄉"
        )

        // 金門縣
        val districts17 = arrayOf(
            "金沙鎮", "金湖鎮", "金寧鄉", "金城鎮", "烈嶼鄉", "烏坵鄉"
        )

        // 屏東縣
        val districts18 = arrayOf(
        ...
        //花蓮縣
        val districts20 = arrayOf(
            "花蓮市", "新城鄉", "秀林鄉", "吉安鄉", "壽豐鄉", "鳳林鎮", "光復鄉", "豐濱鄉",
            "瑞穗鄉", "萬榮鄉", "玉里鎮", "卓溪鄉", "富里鄉"
        )

        // 連江縣
        val districts21 = arrayOf(
            "南竿鄉", "北竿鄉", "莒光鄉", "東引鄉"
        )
    }
}